...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    await supabase.auth.signInWithOAuth({
      provider: "google",
      options: { 
        redirectTo: `${window.location.origin}/dashboard/commands`,
        queryParams: {
          access_type: 'offline',
          prompt: 'consent',
        },
        ...
        <div className="bg-surface border border-border rounded p-8">
          ...
          <div className="flex flex-col gap-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-surface-2 border border-border rounded text-sm text-text hover:border-border-hover transition-all duration-200 cursor-pointer"
            >
