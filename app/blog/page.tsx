...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    description: "Understand the technology behind TermAssist in simple terms. Learn about the BM25 algorithm, why TermAssist is so fast (under 50ms), how it matches your questions to commands, and how it keeps your data 100% private.",
    date: "Apr 16, 2026",
    readTime: "10 min",
  ...
  },
  {
    ...
    description: "Master every feature of the TermAssist dashboard. Learn how to view your command history, create and manage custom snippets, generate API tokens, view usage analytics, and understand how the dashboard syncs with your terminal.",
    date: "Apr 15, 2026",
    readTime: "12 min",
